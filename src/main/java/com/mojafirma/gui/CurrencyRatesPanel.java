...
public class CurrencyRatesPanel extends JFrame {
    ...
    public CurrencyRatesPanel() { iniCurrencyRatesPanel(); }

    CurrencyDao currencyDao = new CurrencyDao();
    RatesTableDao ratesTableDao = new RatesTableDao();

    private void iniCurrencyRatesPanel() {
        ...
        button1.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                RatesChart chart = new RatesChart(currencyName, startDate, endDate);
